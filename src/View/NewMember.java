...
public class NewMember extends javax.swing.JFrame {
    ...
    public NewMember() {
        initComponents();
        jLabel12.setText(clienteService.findMaxId().toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dati anagrafici");
        ...
        jButton2.setBackground(new java.awt.Color(51, 178, 9));
        ...
        jButton3.setBackground(new java.awt.Color(255, 58, 58));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MASTERCARD", "VISA", "PAYPAL", "CONTANTI" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MASCHIO", "FEMMINA" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEDENTARIO", "MODERAMENTE_ATTIVO", "ATTIVO", "ATLETA" }));
        ...
        jLabel14.setText("Stile di vita");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(0, 118, 221));
        jLabel13.setText("Freq. allenamenti");
        ...
        jLabel16.setText("Disformismi/Paraformismi");
        ...
        jLabel18.setText("Anamnesi cliente");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String message;
        // DATA BINDING CLIENTE
        Cliente cliente = new Cliente();
        cliente.setId(Long.valueOf(jLabel12.getText()));
        cliente.setNome(jTextField1.getText());
        cliente.setEmail(jTextField4.getText());
        cliente.setSesso(Genere.valueOf(Genere.class,jComboBox2.getSelectedItem().toString().toUpperCase()));
        cliente.setCellulare(Long.valueOf(jTextField2.getText()));
        cliente.setDataDiNascita(Date.valueOf(jTextField5.getText()));
        cliente.setLuogoDiNascita(jTextField6.getText());
        cliente.setMetodoDiPagamento(MetodoDiPagamento.valueOf(MetodoDiPagamento.class, jComboBox1.getSelectedItem().toString().toUpperCase()));
        
        // DATA BINDING ANAMNESI
        Anamnesi anamnesi = new Anamnesi();
        anamnesi.setCliente(cliente);
        anamnesi.setDismorfismo(jTextArea1.getText());
        anamnesi.setPatologie(jTextArea2.getText());
        anamnesi.setFrequenzaAllenamenti(Integer.parseInt(jTextField3.getText()));
        if(jComboBox4.getSelectedItem().toString().toUpperCase().equals("SI")){
            anamnesi.setSmoker(true);
        } else {
            anamnesi.setSmoker(false);
        }
        anamnesi.setStileDiVita(StileDiVita.valueOf(StileDiVita.class, jComboBox3.getSelectedItem().toString().toUpperCase()));
        
        message = clienteService.insertCliente(cliente);
        clienteService.createAnamnesiCliente(anamnesi);
